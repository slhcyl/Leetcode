...
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 2 then quantity else 0 end),0) as 'Monday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 3 then quantity else 0 end),0) as 'Tuesday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 4 then quantity else 0 end),0) as 'Wednesday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 5 then quantity else 0 end),0) as 'Thursday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 6 then quantity else 0 end),0) as 'Friday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 7 then quantity else 0 end),0) as 'Saturday'
,ifnull(SUM(CASE WHEN dayofweek(order_date) = 1 then quantity else 0 end),0) as 'Sunday'
from items as a
