 ...
 */
SELECT ROUND((100.0 - (COUNT(DISTINCT CASE WHEN s.product_id IS NOT NULL THEN pc.product_category END) * 100.0 / COUNT(DISTINCT pc.product_category))), 10) AS pct_product_categories_never_sold
